...
import com.daniel.leetris.database.StatDatabase;
import com.daniel.leetris.entities.Statistics;
...
//    private AdView mAdView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        letris_btn = findViewById(R.id.letris_btn);
...
//        buy_btn = findViewById(R.id.buy_btn);
        ...
        try {
            baseTime = dtf.parse("Apr 26 2023 00:00");
...
//        mAdView.loadAd(adRequest);
        ...
        review_btn.setOnClickListener(view -> {
            String url = "https://play.google.com/store/apps/details?id=com.daniel.leetris";
...
//        });
        ...
        letris_btn.setOnClickListener(view -> {
        ...
        share_btn.setOnClickListener(v -> {
            ...
            String body = "https://play.google.com/store/apps/details?id=com.daniel.leetris";
            myIntent.putExtra(Intent.EXTRA_TEXT, body);
            startActivity(Intent.createChooser(myIntent, "Летріс"));
        });
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        mFirebaseAnalytics.logEvent(FirebaseAnalytics.Event.SELECT_CONTENT, bundle);
                            ...
                            class NextTask extends AsyncTask<Void, Void, Void> {
                                ...
                                protected void onPostExecute(Void unused) {
                                    super.onPostExecute(unused);
//                                    if (stats.getWords_number() % 50 == 0) {
//                                        //TODO check if works
//
//                                        AdRequest adRequest = new AdRequest.Builder().build();
//
//                                        InterstitialAd.load(MainActivity.this, "ca-app-pub-3801792611280684/1812462238", adRequest,
...
//        String s = "";
    ...
    private void createLine() {
        ...
        String[] six_l = new String[6];
        String[] five_l = new String[17];
        Random r = new Random();
